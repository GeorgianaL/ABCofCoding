...
let flowersPos = [
    { x: 215, y: 225, flowerParcelIndex: 0 },
    { x: 255, y: 225, flowerParcelIndex: 0 },
    { x: 315, y: 220, flowerParcelIndex: 1 },
    { x: 355, y: 220, flowerParcelIndex: 1 },
    { x: 315, y: 250, flowerParcelIndex: 1 },
    { x: 355, y: 250, flowerParcelIndex: 1 },
    { x: 415, y: 225, flowerParcelIndex: 2 },
    { x: 455, y: 225, flowerParcelIndex: 2 },
    { x: 415, y: 255, flowerParcelIndex: 2 },
    { x: 455, y: 255, flowerParcelIndex: 2 },
];
...
const removeFlowers = (index, count) => {
  ...
  if (count > 0) {
    ...
    parcelFlowers = parcelFlowers.splice(0, count);
    // modify initial flowersPos array
    flowersPos = otherParcels.concat(parcelFlowers);
  }
}

class Level6Demo extends React.Component {
  constructor(props) {
    super(props);
    this.svgNode = null;
  }
...
Level6Demo.displayName = 'Level6Demo';
Level6Demo.propTypes = {
  'startGame': PropTypes.bool,
  'playerCode': PropTypes.string,
};
Level6Demo.defaultProps = {
  'startGame': false,
  'playerCode': '',
};

export default Level6Demo;
